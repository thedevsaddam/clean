...
func (_m *UserRepository) Fetch(ctx context.Context, ctr *domain.UserCriteria) ([]*domain.User, error) {
...
func (_m *UserRepository) GetByID(ctx context.Context, id uint) (*domain.User, error) {
	ret := _m.Called(ctx, id)
...
func (_m *UserRepository) Store(ctx context.Context, user *domain.User) (uint, error) {
